...
Тикет — **лимитный** ордер. Можно указать количество или сумму в USD; второе поле считается от лимита. Лимит может следовать за последней ценой или задаётся вручную. **All** подставляет сумму на весь доступный кэш. Buy недоступен, если ставка (с комиссией) больше кэша.
